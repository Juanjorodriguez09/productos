...
public class RegistroController {
    ...
    // Método para inicializar los listeners de los botones de la vista de registro
    ...
    private void registerCliente() throws Exception {
        ...
        // Obtener el nombre y la fecha de nacimiento ingresados por el usuario
    ...
    // Método para abrir la ventana de inicio de sesión y cerrar la ventana de registro
